...
const SChart = ({ sensorId, hours = 24, limit = null }) => {
  ...
  const chart_period_text = limit
    ? `Последние ${limit} замеров из PostgreSQL. Загружено точек: ${measurements.length}.`
  ...
  return (
    <div className="achart">
      <div className="chartHeader">
        ...
        <select value={current_sensor_id} onChange={(event) => select_sensor_id(event.target.value)}>
